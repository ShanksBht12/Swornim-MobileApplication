...
class DecoratorProfileForm extends ConsumerStatefulWidget {
  const DecoratorProfileForm({super.key});

  @override
  ConsumerState<DecoratorProfileForm> createState() => _DecoratorProfileFormState();
}

class _DecoratorProfileFormState extends ConsumerState<DecoratorProfileForm> {
  ...
  Future<void> _submitForm() async {
    ...
    final url = Uri.parse('${AppConfig.decoratorsUrl}/profile');
