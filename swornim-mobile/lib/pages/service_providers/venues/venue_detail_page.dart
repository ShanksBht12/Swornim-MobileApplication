...
class _VenueDetailPageState extends ConsumerState<VenueDetailPage> with TickerProviderStateMixin {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Price Per Hour: Rs. ${venue.pricePerHour.toStringAsFixed(2)}', style: theme.textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.w600)),
              const SizedBox(height: 24),
              // Equipment section
              _buildInfoSection(
                'Equipment & Gear',
  ...
  String? _getImageUrl(Venue venue, int index) {
    ...
    if (index == 0 && venue.image.isNotEmpty) {
      ...
      if (portfolioIndex >= 0 && portfolioIndex < venue.images.length) {
        url = venue.images[portfolioIndex];
      }
    }
  ...
  // 2. Add this method to _VenueDetailPageState to force refresh
